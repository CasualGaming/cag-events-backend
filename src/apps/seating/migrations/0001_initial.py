# Generated by Django 2.2.2 on 2019-07-01 08:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ticket', '0002_auto_20190701_0824'),
        ('event', '0001_initial'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': [('view_area', '(Admin panel) View seating areas'), ('add_area', '(Admin panel) Add seating areas'), ('change_area', '(Admin panel) Change seating areas'), ('delete_area', '(Admin panel) Delete seating areas')],
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'permissions': [('layout.list', 'List seating layouts'), ('layout.create', 'Create seating layouts'), ('layout.change', 'Change seating layouts'), ('layout.delete', 'Delete seating layouts'), ('layout.view_inactive', 'View inactive seating layouts'), ('view_arealayout', '(Admin panel) View seating area layouts'), ('add_arealayout', '(Admin panel) Add seating area layouts'), ('change_arealayout', '(Admin panel) Change seating area layouts'), ('delete_arealayout', '(Admin panel) Delete seating area layouts')],
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'permissions': [('seating.list', 'List seatings'), ('seating.view_inactive', 'View inactive seatings'), ('view_seating', '(Admin panel) View seatings'), ('add_seating', '(Admin panel) Add seatings'), ('change_seating', '(Admin panel) Change seatings'), ('delete_seating', '(Admin panel) Delete seatings')],
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('row_number', models.IntegerField(help_text='Row number in the area.', validators=[django.core.validators.MinValueValidator(1)], verbose_name='row number')),
                ('seat_number', models.IntegerField(help_text='Seat number in the row. Horizontal-major numbering.', validators=[django.core.validators.MinValueValidator(1)], verbose_name='seat number')),
                ...
                ('assigned_ticket', models.OneToOneField(blank=True, help_text='Ticket tied to this seat if it is assigned.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='seat', to='ticket.Ticket', verbose_name='assigned ticket')),
            ...
            options={
                'permissions': [('view_seat', '(Admin panel) View seats')],
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='applicable_rows', to='seating.Area', verbose_name='area')),
            ...
            options={
                'permissions': [('view_rowtickettypes', '(Admin panel) View seating row ticket types'), ('add_rowtickettypes', '(Admin panel) Add seating row ticket types'), ('change_rowtickettypes', '(Admin panel) Change seating row ticket types'), ('delete_rowtickettypes', '(Admin panel) Delete seating row ticket types')],
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'permissions': [('view_rowlayout', '(Admin panel) View seating row layouts'), ('add_rowlayout', '(Admin panel) Add seating row layouts'), ('change_rowlayout', '(Admin panel) Change seating row layouts'), ('delete_rowlayout', '(Admin panel) Delete seating row layouts')],
                'default_permissions': [],
            },
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name='seat',
            constraint=models.CheckConstraint(check=models.Q(('assigned_ticket__exact', None), ('is_reserved__exact', False), _connector='OR'), name='not_reserved_and_assigned'),
        ),
        migrations.AddConstraint(
