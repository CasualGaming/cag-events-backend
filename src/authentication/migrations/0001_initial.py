...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': [('user.list', 'List users'), ('user.view_basic', "View users' non-address info"), ('user.view_address', "View users' address"), ('user.delete', 'Delete users'), ('view_user', '(Admin panel) View users'), ('delete_user', '(Admin panel) Delete users')],
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'permissions': [('view_groupextension', '(Admin panel) View group extensions')],
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'permissions': [('view_userprofile', '(Admin panel) View user profiles')],
                'default_permissions': [],
            },
        ),
    ]
