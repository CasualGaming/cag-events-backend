    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('user.list', 'Can list users'), ('user.view_basic', 'Can view everything except address'), ('user.view_address', 'Can view address'), ('user.delete', 'Can delete users')],
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
